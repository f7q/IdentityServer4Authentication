...
using IdentityServer4Authentication.Models.ManageViewModels;
...
namespace IdentityServer4Authentication.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> ManageLogins(ManageMessageId? message = null)
        {
            ...
            //var otherLogins = _signInManager.GetExternalAuthenticationSchemes().Where(auth => userLogins.All(ul => auth.Name != ul.LoginProvider)).ToList();
